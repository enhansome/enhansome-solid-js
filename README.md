...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,895 | 🐛 104 | 📅 2026-08-18
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 35,872 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-19
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 35,872 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-19
...
* [Solid Templates](https://github.com/solidjs/templates) ⭐ 539 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-18(official)
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 598 | 🐛 4 | 🌐 Rust | 📅 2026-08-17 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [ArkEnv](https://github.com/yamcodes/arkenv) ⭐ 139 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-19 - Environment variable validation from editor to runtime, integrates with Solid and SolidStart via its Vite plugin.
...
* [Unplugin Icons](https://github.com/antfu/unplugin-icons) ⭐ 4,932 | 🐛 86 | 🌐 TypeScript | 📅 2026-01-14 ([NPM](https://www.npmjs.com/package/unplugin-icons))
...
* [Neodrag](https://github.com/PuruVJ/neodrag) ⭐ 2,448 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-10 ([NPM](https://www.npmjs.com/package/@neodrag/solid))
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,718 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-19 ([NPM](https://www.npmjs.com/package/virtua))
...
* [Solid App Router](https://github.com/solidjs/solid-app-router) ⭐ 1,317 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-19(official)
...
* [Solid Primitives — i18n](https://github.com/solidjs-community/solid-primitives/tree/main/packages/i18n#readme) ⭐ 1,548 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-18 - Library of internationalisation primitives.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,872 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-19 - Library for authoring web components with SolidJS.
...
* [Solid Headless](https://github.com/LXSMNSYC/solid-headless) ⭐ 702 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-19 - Headless UI for SolidJS
...
* [LocatorJS](https://github.com/infi-pc/locatorjs) ⭐ 1,824 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-07 - Click on any component to go to it's code. (it's also built with SolidJS)
...
* [ESBuild Solid Plugin](https://github.com/amoutonbrady/esbuild-plugin-solid) ⭐ 66 | 🐛 4 | 🌐 TypeScript | 📅 2025-02-10 ([NPM](https://www.npmjs.com/package/esbuild-plugin-solid)) - Plugin to compile solid-js jsx components with ESbuild.
...
* [Solid Start](https://github.com/solidjs/solid-start) ⭐ 5,909 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-19 - Official meta framework for SolidJS
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 13,903 | 🐛 173 | 🌐 TypeScript | 📅 2026-07-21([playground](https://mitosis.builder.io/?outputTab=solid))
