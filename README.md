...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,113 | 🐛 106 | 📅 2026-09-02
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 35,957 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 35,957 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05
...
* [Solid Templates](https://github.com/solidjs/templates) ⭐ 538 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05(official)
...
* [Codeimage.dev](https://github.com/riccardoperra/codeimage) ⭐ 2,086 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-28 - Create elegant screenshots of your source code. Built with SolidJS
* [Tura](https://github.com/Tura-AI/tura) ⭐ 613 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [ArkEnv](https://github.com/yamcodes/arkenv) ⭐ 140 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-05 - Environment variable validation from editor to runtime, integrates with Solid and SolidStart via its Vite plugin.
...
* [Unplugin Icons](https://github.com/antfu/unplugin-icons) ⭐ 4,934 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-04 ([NPM](https://www.npmjs.com/package/unplugin-icons))
...
* [Solid MDX](https://github.com/high1/solid-jsx) ⭐ 87 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-04
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,735 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-04 ([NPM](https://www.npmjs.com/package/virtua))
...
* [Solid App Router](https://github.com/solidjs/solid-app-router) ⭐ 1,318 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-04(official)
...
* [Solid Primitives — i18n](https://github.com/solidjs-community/solid-primitives/tree/main/packages/i18n#readme) ⭐ 1,554 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-02 - Library of internationalisation primitives.
...
* [Effector](https://github.com/effector/effector/tree/master/packages/effector-solid) ⭐ 4,850 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-01
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,957 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05 - Library for authoring web components with SolidJS.
...
* [LocatorJS](https://github.com/infi-pc/locatorjs) ⭐ 1,823 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-02 - Click on any component to go to it's code. (it's also built with SolidJS)
...
* [Solid Start](https://github.com/solidjs/solid-start) ⭐ 5,918 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-24 - Official meta framework for SolidJS
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,354 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21([playground](https://mitosis.builder.io/?outputTab=solid))
