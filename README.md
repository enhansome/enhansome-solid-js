...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,262 | 🐛 106 | 📅 2026-09-02
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 36,026 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-12
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 36,026 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-12
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 625 | 🐛 3 | 🌐 Rust | 📅 2026-09-10 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [ArkEnv](https://github.com/yamcodes/arkenv) ⭐ 141 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-12 - Environment variable validation from editor to runtime, integrates with Solid and SolidStart via its Vite plugin.
...
* [Solid App Router](https://github.com/solidjs/solid-app-router) ⭐ 1,318 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-12(official)
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,026 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-12 - Library for authoring web components with SolidJS.
...
* [Solid Start](https://github.com/solidjs/solid-start) ⭐ 5,920 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-11 - Official meta framework for SolidJS
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,374 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21([playground](https://mitosis.builder.io/?outputTab=solid))
