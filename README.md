...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,653 | 🐛 106 | 📅 2026-09-02
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 36,011 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-10
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 36,011 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-10
...
* [Solid Templates](https://github.com/solidjs/templates) ⭐ 538 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-10(official)
...
* [Codeimage.dev](https://github.com/riccardoperra/codeimage) ⭐ 2,088 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-28 - Create elegant screenshots of your source code. Built with SolidJS
* [Tura](https://github.com/Tura-AI/tura) ⭐ 621 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [Unplugin Icons](https://github.com/antfu/unplugin-icons) ⭐ 4,934 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-10 ([NPM](https://www.npmjs.com/package/unplugin-icons))
...
* [Solid MapGL](https://github.com/GIShub4/solid-map-gl) ⭐ 137 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-10
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,739 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-10 ([NPM](https://www.npmjs.com/package/virtua))
...
* [Solid App Router](https://github.com/solidjs/solid-app-router) ⭐ 1,318 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-10(official)
...
* [Solid Primitives — i18n](https://github.com/solidjs-community/solid-primitives/tree/main/packages/i18n#readme) ⭐ 1,556 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-05 - Library of internationalisation primitives.
...
* [Effector](https://github.com/effector/effector/tree/master/packages/effector-solid) ⭐ 4,849 | 🐛 167 | 🌐 TypeScript | 📅 2026-09-10
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,011 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-10 - Library for authoring web components with SolidJS.
...
* [LocatorJS](https://github.com/infi-pc/locatorjs) ⭐ 1,823 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-09 - Click on any component to go to it's code. (it's also built with SolidJS)
* [ESLint for Solid](https://github.com/joshwilsonvu/eslint-plugin-solid) ⭐ 266 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-08 - Solid-specific linting rules for ESLint
...
* [Solid Start](https://github.com/solidjs/solid-start) ⭐ 5,921 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-24 - Official meta framework for SolidJS
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,369 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21([playground](https://mitosis.builder.io/?outputTab=solid))
