...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,041 | 🐛 106 | 📅 2026-08-21
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 35,903 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-22
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 35,903 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-22
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 600 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [ArkEnv](https://github.com/yamcodes/arkenv) ⭐ 139 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-22 - Environment variable validation from editor to runtime, integrates with Solid and SolidStart via its Vite plugin.
...
* [Solid MDX](https://github.com/high1/solid-jsx) ⭐ 87 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-22
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,722 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-23 ([NPM](https://www.npmjs.com/package/virtua))
...
* [Solid App Router](https://github.com/solidjs/solid-app-router) ⭐ 1,317 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-22(official)
...
* [Solid Primitives — i18n](https://github.com/solidjs-community/solid-primitives/tree/main/packages/i18n#readme) ⭐ 1,551 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-22 - Library of internationalisation primitives.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,903 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-22 - Library for authoring web components with SolidJS.
...
* [LocatorJS](https://github.com/infi-pc/locatorjs) ⭐ 1,824 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-22 - Click on any component to go to it's code. (it's also built with SolidJS)
...
* [Babel Solid Plugin - Labels](https://github.com/LXSMNSYC/babel-plugin-solid-labels) ⭐ 255 | 🐛 3 | 🌐 TypeScript | 📅 2025-03-14 - Simple, reactive labels for SolidJS
...
* [Solid Start](https://github.com/solidjs/solid-start) ⭐ 5,913 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-23 - Official meta framework for SolidJS
