...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,531 | 🐛 105 | 📅 2026-09-02
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 35,956 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-03
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 35,956 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-03
...
* [Solid Templates](https://github.com/solidjs/templates) ⭐ 538 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-03(official)
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 611 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [ArkEnv](https://github.com/yamcodes/arkenv) ⭐ 140 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-03 - Environment variable validation from editor to runtime, integrates with Solid and SolidStart via its Vite plugin.
...
* [Solid Floating UI](https://github.com/lxsmnsyc/solid-floating-ui) ⭐ 99 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-03
...
* [Unplugin Icons](https://github.com/antfu/unplugin-icons) ⭐ 4,935 | 🐛 88 | 🌐 TypeScript | 📅 2026-01-14 ([NPM](https://www.npmjs.com/package/unplugin-icons))
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,733 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-03 ([NPM](https://www.npmjs.com/package/virtua))
...
* [Solid App Router](https://github.com/solidjs/solid-app-router) ⭐ 1,317 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-02(official)
...
* [Solid Primitives — i18n](https://github.com/solidjs-community/solid-primitives/tree/main/packages/i18n#readme) ⭐ 1,555 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-02 - Library of internationalisation primitives.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,956 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-03 - Library for authoring web components with SolidJS.
...
* [Solid Headless](https://github.com/LXSMNSYC/solid-headless) ⭐ 702 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-02 - Headless UI for SolidJS
...
* [Solid Testing Library](https://github.com/solidjs/solid-testing-library) ⭐ 227 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-02(official)
...
* [Solid Styled](https://github.com/LXSMNSYC/solid-styled) ⭐ 196 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - Reactive stylesheets for SolidJS
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,303 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21([playground](https://mitosis.builder.io/?outputTab=solid))
