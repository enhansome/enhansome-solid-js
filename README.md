...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,351 | 🐛 105 | 📅 2026-08-18
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 35,886 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-20
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 35,886 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-20
...
* [Solid Templates](https://github.com/solidjs/templates) ⭐ 539 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-21(official)
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 599 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [ArkEnv](https://github.com/yamcodes/arkenv) ⭐ 139 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-20 - Environment variable validation from editor to runtime, integrates with Solid and SolidStart via its Vite plugin.
...
* [Unplugin Icons](https://github.com/antfu/unplugin-icons) ⭐ 4,933 | 🐛 86 | 🌐 TypeScript | 📅 2026-01-14 ([NPM](https://www.npmjs.com/package/unplugin-icons))
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,721 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-20 ([NPM](https://www.npmjs.com/package/virtua))
...
* [Solid App Router](https://github.com/solidjs/solid-app-router) ⭐ 1,317 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-19(official)
...
* [Effector](https://github.com/effector/effector/tree/master/packages/effector-solid) ⭐ 4,847 | 🐛 158 | 🌐 TypeScript | 📅 2026-07-25
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,886 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-20 - Library for authoring web components with SolidJS.
...
* [ESLint for Solid](https://github.com/joshwilsonvu/eslint-plugin-solid) ⭐ 266 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-20 - Solid-specific linting rules for ESLint
...
* [Solid Start](https://github.com/solidjs/solid-start) ⭐ 5,912 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-20 - Official meta framework for SolidJS
