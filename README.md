...
## Awesome Solid.js [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,430 | 🐛 106 | 📅 2026-09-02
...
* [GitHub Repo](https://github.com/solidjs/solid) ⭐ 35,965 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-06
* [Release Notes](https://github.com/solidjs/solid/releases) ⭐ 35,965 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-06
...
* [Solid Templates](https://github.com/solidjs/templates) ⭐ 538 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-05(official)
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 616 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. Its desktop GUI is built with SolidJS.
  *more coming soon...*
...
* [ArkEnv](https://github.com/yamcodes/arkenv) ⭐ 141 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-05 - Environment variable validation from editor to runtime, integrates with Solid and SolidStart via its Vite plugin.
...
* [Unplugin Icons](https://github.com/antfu/unplugin-icons) ⭐ 4,932 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-05 ([NPM](https://www.npmjs.com/package/unplugin-icons))
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,735 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-06 ([NPM](https://www.npmjs.com/package/virtua))
...
* [Solid Primitives — i18n](https://github.com/solidjs-community/solid-primitives/tree/main/packages/i18n#readme) ⭐ 1,554 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-05 - Library of internationalisation primitives.
...
* [Effector](https://github.com/effector/effector/tree/master/packages/effector-solid) ⭐ 4,850 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-06
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,965 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-06 - Library for authoring web components with SolidJS.
...
* [ESLint for Solid](https://github.com/joshwilsonvu/eslint-plugin-solid) ⭐ 266 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-29 - Solid-specific linting rules for ESLint
...
* [Mitosis](https://github.com/BuilderIO/mitosis) ⭐ 14,357 | 🐛 176 | 🌐 TypeScript | 📅 2026-07-21([playground](https://mitosis.builder.io/?outputTab=solid))
